...
#convert the Snowpark Dataframe to a Pandans Datafrae so we can use teh LOC function
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        smoothiefroot_response = requests.get(f"https://my.smoothiefroot.com/api/fruit/{search_on}")  # Making Use of the SEARCH_ON Value
